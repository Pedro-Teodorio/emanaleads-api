...
router.get('/:projectId/campaigns/metrics', auth_middleware_1.authMiddleware, (0, validateRole_middleware_1.validateRole)(['ROOT', 'ADMIN']), campaign_controller_1.campaignController.getMetrics);
