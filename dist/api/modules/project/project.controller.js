...
class ProjectController {
    ...
    async getById(req, res, next) {
        try {
            ...
            const project = await project_service_1.projectService.getById(projectId, req.user);
    ...
    async getMetrics(req, res, next) {
        try {
            const { projectId } = req.params;
            const metrics = await project_service_1.projectService.getMetrics(projectId, req.user);
